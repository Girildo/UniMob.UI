...
namespace UniMob.UI
{
    ...
    public static class Ease
    {
        ...
        {
            if (d <= 0f)
                return 1f; // prevent division by zero, an animation with zero duration is considered complete
        ...
        // --- SINE ---
        public static Easing InSine =>
            (t, d) => 1 - Mathf.Cos((NormalizedTime(t, d) * Mathf.PI) / 2);
        ...
        // --- CIRC ---
        public static Easing InCirc =>
            (t, d) => 1 - Mathf.Sqrt(1 - Mathf.Pow(NormalizedTime(t, d), 2));
        public static Easing OutCirc =>
            (t, d) => Mathf.Sqrt(1 - Mathf.Pow(NormalizedTime(t, d) - 1, 2));
        public static Easing InOutCirc => Combine(InCirc, OutCirc);

        // --- BACK ---
        public static Easing InBack =>
            (t, d) =>
            {
